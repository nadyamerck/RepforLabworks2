...
class TestLibrary(unittest.TestCase):
    ...
    def test_init(self):
        ...
        try:
            self.assertNotEqual(
                inspect._empty,
                signature.parameters['books'].default,
    ...
    def test_next(self):
        self.assertTrue(
            'get_next_book_id' in [name for name, _ in inspect.getmembers(task.Library)],
    ...
    def test_x_by_id(self):
        self.assertTrue(
            'get_index_by_book_id' in [name for name, _ in inspect.getmembers(task.Library)],
